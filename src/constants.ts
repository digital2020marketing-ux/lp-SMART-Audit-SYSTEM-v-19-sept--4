...
// Seluruh tombol CTA (Hero, Offer, Closing, Mobile Sticky) 100% menggunakan getCheckoutUrl().
// Untuk beralih ke Order Hero, Anda cukup mengganti BASE_CHECKOUT_URL di bawah atau set VITE_CHECKOUT_URL.
